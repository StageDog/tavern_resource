...
async function toggle_lock(should_lock) {
...
function register_button() {
    ...
    eventOnButton('处理要禁用递归扫描的世界书', async () => {
        ...
        let choosen_lorebook = null;
        const $template = $('<div>').append('<div><h4><span>请选择你要处理的世界书</span></h4></div>', $('<div>').append($('<select><option value="">--- None ---</option></select>')
